...
export default function Voting() {
  ...
  async function giveRightToVote() {
    ...
    const rightPrice = await contract.estimateGas.giveRightToVote(
      enableAddress
    );
  ...
  return (
    <div className="flex flex-col bg-white font-mono">
      ...
      <Link className="hover:text-red hover:underline" to="/votingInfo">
        Contract Info
      </Link>
      ...
      <div className="flex flex-row justify-around bg-white font-mono mt-20">
        <div>
          ...
          <p>
            <p>
              Chairperson is:{chairPerson}
              <br />
              Estimated gas price: {chairPrice}
            </p>
            <br />
            <button className="border mt-2 w-40" onClick={checkChairperson}>
              Get chairperson
            </button>
            <br />
            ...
            <br />
            <button className="border mt-12 w-40" onClick={getUserInfo}>
              Get user info
            </button>
          </p>
        </div>
        <div>
          ...
          <p>
            ...
            <br />
            <button className="border mt-12 w-40" onClick={fetchCandidates}>
              Get Candidates
            </button>
          </p>
        </div>
      ...
      <div className="flex flex-col bg-white font-mono">
        ...
        <div>
          <button onClick={fetchWinningProposal} className="border mt-12 w-40">
      ...
      <div className="flex flex-col bg-white font-mono">
        ...
        <div>
          ...
          />
          <br />
          <button onClick={giveRightToVote} className="border mt-2 w-40 mb-2">
            Give right to vote
          </button>
          <br />
      ...
      <div className="flex flex-col bg-white font-mono mt-6">
        ...
        <div>
          ...
          <button onClick={delegateRights} className="border mt-2 w-40">
            Delegate your rights to
          </button>
          <br />
        </div>
      ...
      <div className="flex flex-col bg-white font-mono">
        ...
        <div>
          ...
          />
          <br />
          <button onClick={vote} className="border mt-12 w-40">
            Vote For
          </button>
          <br />
      ...
      <div className="flex flex-col bg-white font-mono">
        <div></div>
        <div>
          <button onClick={getWinnerName} className="border mt-12 w-40">
            {" "}
            Get winner name
          </button>
          <br />
