  ...
  async function loadNFTs() {
    try {
      const provider = new ethers.providers.StaticJsonRpcProvider(
        "https://rinkeby.infura.io/v3/e3131bbb80dd494ca44a62bc7fd461e3"
      );
        ...
        <div className="px-4" style={{ maxWidth: "1600px" }}>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-4">
            {NFTs.map((nft, i) => (
              <div
                key={i}
                className="border shadow rounded-xl overflow-hidden p-2"
              >
                <p
                  style={{ height: "64px" }}
                ...
                <div className="p-4 bg-black">
                  <p className="text-2xl mb-4 font-bold text-primary">
                    Price:{nft.price} ETH
                  </p>
                  <button
